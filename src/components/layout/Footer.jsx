...
const Footer = () => {
  ...
  return (
    <footer className="w-full py-6 px-4 backdrop-blur-md bg-white/80 dark:bg-slate-900/80 border-t border-white/20 dark:border-slate-700/20 text-slate-600 dark:text-slate-400 shadow-lg shadow-blue-500/5">
